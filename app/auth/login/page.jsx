      ...
      <div className="grid w-full gap-10 lg:grid-cols-[1fr_0.95fr]">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-slate-950">
            Sign in to manage your security subscription and profile.
          </h1>
          <p className="max-w-xl text-lg leading-8 text-slate-600">
            Your session is persisted securely and will expire automatically based on
            the backend token policy.
          </p>
        </div>
